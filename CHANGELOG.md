...
### Fixed
- Updated device and entity registry iteration to use Home Assistant's supported iterable API, avoiding deprecated mapping access that will be removed in Home Assistant 2027.9.0.
